...
export function TripDetailsModal({ trip, isOpen, onClose, onEdit, onDelete }: TripDetailsModalProps) {
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
          <Chip
            ...
            label={<span style={{ textTransform: 'capitalize' }}>{trip.mode}</span>}
            sx={{
              border: '1px solid #e5e5e5',
              backgroundColor: '#f5f5f5',
              color: '#404040',
          ...
          <Chip
            ...
            label={<span style={{ textTransform: 'capitalize' }}>{trip.visibility}</span>}
            sx={{
              border: '1px solid #e5e5e5',
              backgroundColor: '#f5f5f5',
              color: '#404040',
        ...
        <Box>
          ...
          <Box component="ol" sx={{ display: 'flex', flexDirection: 'column', gap: 1, pl: 0, listStyle: 'none' }}>
            {trip.route.map((location, index) => (
              ...
              >
                ...
                <Typography sx={{ pt: 0.5, color: '#404040', fontSize: '1rem' }}>
                  {location}
                </Typography>
              </Box>
            ))}
