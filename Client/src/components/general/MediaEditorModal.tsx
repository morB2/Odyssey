...
export function MediaEditorModal({
  ...
  // Update originalUrl when mediaUrl changes
  const [originalUrl, setOriginalUrl] = useState(() =>
    getOriginalCloudinaryUrl(mediaUrl)
  );

  // Update originalUrl when mediaUrl changes
  useEffect(() => {
    setOriginalUrl(getOriginalCloudinaryUrl(mediaUrl));
  }, [mediaUrl]);
  ...
  // Update preview when originalUrl changes
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (isVideoMedia) {
      const transformed = applyVideoTransformations(originalUrl, {
        ...
        watermark: debouncedWatermarkText
          ? { text: debouncedWatermarkText }
          : undefined,
      });
  ...
  const handleImageEffectChange = useCallback(
    (key: keyof ImageEffects, value: number | boolean) => {
                  ...
                  {quickFilters.map((preset) => {
                    ...
                    return (
                      <Button
                        key={preset.name}
                        onClick={() =>
                          applyQuickFilter(preset.name, preset.effects)
                        }
                        variant={
              ...
              <>
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("brightness", value as number)
                    }
                    min={-99}
                    max={100}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("contrast", value as number)
                    }
                    min={-100}
                    max={100}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("saturation", value as number)
                    }
                    min={-100}
                    max={100}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("hue", value as number)
                    }
                    min={-100}
                    max={100}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("sharpen", value as number)
                    }
                    min={0}
                    max={2000}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("blur", value as number)
                    }
                    min={0}
                    max={2000}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("vignette", value as number)
                    }
                    min={0}
                    max={100}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("pixelate", value as number)
                    }
                    min={0}
                    max={200}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      handleImageEffectChange("vibrance", value as number)
                    }
                    min={-100}
                    max={100}
                    size="small"
                ...
                <Box>
                  ...
                  <Slider
                    ...
                    onChange={(_, value) =>
                      setVideoTransforms((prev) => ({
                        ...prev,
                        startOffset: (value as number) || undefined,
                      }))
                    }
                    min={0}
                    max={30}
