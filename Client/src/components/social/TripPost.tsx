...
//             <Card sx={{ maxWidth: { xs: '100%', sm: 600, md: 700 }, mx: 'auto', mb: 3, borderRadius: '16px', boxShadow: '0 6px 18px rgba(0,0,0,0.08)', overflow: 'hidden' }}>
//                 {/* Header */}
//                 <CardContent>
//                     <Box display="flex" alignItems="center" justifyContent="space-between">
//                         <Box display="flex" alignItems="center" gap={1.5}>
                ...
                <DialogContent dividers>
                    <Grid container spacing={3}>
                        ...
                        <Grid size={{xs:12, md:6}}>
                            <Box position="relative" sx={{ bgcolor: 'grey.200', borderRadius: 2, overflow: 'hidden' }}>
                                <img
